# Arbeitsblätter 1–24 · Fassung 3

Stand: 7. September 2026 · Schritt 2 abgeschlossen

Die Kinder arbeiten mit ausgedruckten Materialien und ihrem Heft. Jeder Arbeitsauftrag nennt den Arbeitsort. Ziel, Hilfe und Selbstcheck stehen auf jedem Blatt. Online-Zugriff ist nicht erforderlich.
...
Alle 24 Blätter enthalten kurze Du-Aufträge mit erkennbarem Arbeitsort. Schulwünsche, Briefteile und freundliche Formulierungen werden durch Ankreuzen, Zuordnen, Markieren, mündliches Planen, Schreiben und Überarbeiten geübt. Gründe, Daten und der Umgang mit Bedenken bleiben als freiwillige Vertiefung erhalten. Vollständige Briefchecklisten nennen auch Ort und Datum. Passende Texte müssen nicht künstlich verändert werden. Blatt 22–24 leiten aus eigenen Texten konkrete nächste Lernschritte ab.

## Bearbeitung

Die Inhalte stehen in `arbeitsblaetter_inhalte.json`. `tools/generate_arbeitsblaetter.py` erzeugt daraus die DOCX (benötigt python-docx). Nach Änderungen erneut als PDF rendern und alle Seiten auf Umbrüche und Lesbarkeit prüfen. DOCX und PDF immer gemeinsam aktualisieren.
